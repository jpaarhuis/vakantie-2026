...
| Nîmes / Pont du Gard | Hôtel/Villa Majestic, Appart'City Arènes of Appart'City Centre | <span class="status-check">accommodatiecheck klaar</span> Voorkeur is Nîmes centrum: Majestic voor één familie-opzet, Appart'City Arènes/Odalys voor ligging met 2 units, Appart'City Centre als T3-fallback. |
...
- Kies waar mogelijk hotels met echte laadstations, niet alleen “stopcontact beschikbaar”.
- Gebruik laadmomenten rond maaltijden of activiteiten.
- Laad op reisdagen liever eerder dan later; met gezin en hitte wil je geen laadstress.
- Controleer bij campings en gîtes expliciet of laden is toegestaan.
- Plan snelladers langs de route, maar boek verblijf niet uitsluitend op basis van één laadpaal.

## Gezin van vijf

Een gezin van vijf is in Frankrijk net onhandig: veel familiekamers stoppen bij vier personen. Daardoor zijn appartementen, aparthotels en gîtes vaak praktischer. Bij hotels moet je expliciet zoeken op “5 personnes”, “family room 5 people” of “suite familiale 5 personnes”.

## Mijn voorkeurskeuze per stop
...
| Nîmes / Pont du Gard | Hôtel/Villa Majestic of Appart'City Arènes/Centre | Nîmes zelf zien; Majestic is beste eerste check, Pont du Gard als korte rit |
